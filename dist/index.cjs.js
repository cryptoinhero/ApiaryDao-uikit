...
var pulse$1 = styled.keyframes(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"], ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"])));
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink$1, { href: "https://pancakeswap.finance/swap?outputCurrency=0xb275EfE3b2938724d3c7D3AaBD83c892dd506409", target: "_blank" },
        React__default['default'].createElement(Icon$1v, { width: "28px", mr: "8px" }),
...
var pulse = styled.keyframes(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  0% { transform: rotate(0deg); }\n  20% { transform: rotate(360deg); }\n  40% { transform: rotate(0deg); }\n  50% { transform: scale(1); }\n  55% { transform: scale(1.1); }\n  60% { transform: scale(1.2); }\n  65% { transform: scale(1.3); }\n  70% { transform: scale(1.4); }\n  75% { transform: scale(1.5); }\n  80% { transform: scale(1.2); }\n  90% { transform: scale(1.1); }\n  100% { transform: scale(1); }\n"], ["\n  0% { transform: rotate(0deg); }\n  20% { transform: rotate(360deg); }\n  40% { transform: rotate(0deg); }\n  50% { transform: scale(1); }\n  55% { transform: scale(1.1); }\n  60% { transform: scale(1.2); }\n  65% { transform: scale(1.3); }\n  70% { transform: scale(1.4); }\n  75% { transform: scale(1.5); }\n  80% { transform: scale(1.2); }\n  90% { transform: scale(1.1); }\n  100% { transform: scale(1); }\n"])));
...
var MenuItem$1 = function (_a) {
    ...
    return (React__default['default'].createElement(StyledMenuItemContainer, { "$isActive": isActive, "$variant": variant }, !isDocs ? (React__default['default'].createElement(StyledMenuItem, __assign({ as: reactRouterDom.Link, to: href, "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children)) : (React__default['default'].createElement(StyledMenuItem, __assign({ as: "a", href: href, target: "_blank", "$isActive": isActive, "$variant": variant, "$statusColor": statusColor }, props), children))));
};
...
var BottomNavItem = function (_a) {
    ...
    return showItemsOnMobile ? (React__default['default'].createElement(StyledBottomNavItem, __assign({ type: "button" }, props), bottomNavItemContent)) : (isDocs ? (React__default['default'].createElement(StyledBottomNavItem, __assign({ as: "a", href: href, target: "_blank" }, props), bottomNavItemContent)) : (React__default['default'].createElement(StyledBottomNavItem, __assign({ as: reactRouterDom.Link, to: href }, props), bottomNavItemContent)));
};
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://pancakeswap.finance/swap?outputCurrency=0xb275EfE3b2938724d3c7D3AaBD83c892dd506409", target: "_blank", scale: "sm", variant: "light", endIcon: React__default['default'].createElement(Icon$26, { color: darkColors.textSubtle }) }, buyCakeLabel))))));
};
...
var MenuItems = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default['default'].createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default['default'].createElement(MenuItem$1, { href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isActive: isActive, statusColor: statusColor, isDocs: isDocs }, isLogo ? (React__default['default'].createElement(IconComponent, { width: "60", height: "60", iconName: icon, color: isActive ? "secondary" : "textSubtle" })) : label)));
    })));
};
...
var ApydPrice = function (_a) {
    ...
    return apydPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.finance/swap?outputCurrency=0xc5310dc104473f5e0dd025f1862bb697b3912296", target: "_blank" },
        React__default['default'].createElement(Icon$1o, { width: "28px", mr: "8px" }),
...
var Menu$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        subLinks && React__default['default'].createElement(SubMenuItems, { items: subLinks, mt: MENU_HEIGHT + "px", activeItem: activeSubItem }),
        React__default['default'].createElement(BodyWrapper, { mt: !subLinks ? MENU_HEIGHT + "px" : "0" },
...
var NoProfileMenuIcon = function () { return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "secondary" },
    React__default['default'].createElement(Icon$k, { color: "secondary", width: "24px" }))); };
